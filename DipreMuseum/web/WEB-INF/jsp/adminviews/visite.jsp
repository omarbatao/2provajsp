                    ...
                    <%
                        ...
                        if (request.getParameter("eliminato") != null) {
                            if (request.getParameter("eliminato").equals("true")) {
                                ...
                                out.write(" <div class='alert alert-danger' role='alert'>Error service not visit </div>");
                            }
                        }
                    %>
                ...
                <div class="col-md-12">
                    <form class="form-inline" role="search" action="./cercavisit" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="code" class="form-control" placeholder="Find visit by id">
                        </div>
